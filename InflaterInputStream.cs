...
using mccs.ZLib.Zip.Compression;
using mccs.ZLib.Checksums;

namespace mccs.ZLib.Zip.Compression.Streams
{
    ...
    /// as the <see cref="mccs.ZLib.GZip.GZipInputStream">GZipInputStream</see>.
    ///
